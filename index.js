#!/usr/bin/env node
/**
 * Fetch coduri reducere Fashion Days de pe shopilo.ro
 * Homepage: https://shopilo.ro/magazin/fashiondays.ro
 */

const SHOPILO_URL = "https://shopilo.ro/magazin/fashiondays.ro";
const STORE_NAME  = "Fashion Days";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-ro/cod-reducere-fashion-days)" }
  });
