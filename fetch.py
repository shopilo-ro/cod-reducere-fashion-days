#!/usr/bin/env python3
"""
Fetch coduri de reducere Fashion Days de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/fashiondays.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/fashiondays.ro"
STORE_NAME = "Fashion Days"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru Fashion Days de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-fashion-days)"
    }
    try:
